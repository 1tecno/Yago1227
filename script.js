...
function setTheme(themeName) {
  ...
  if (themeName === "theme-retro") document.getElementById("retroSound").play();
  else document.getElementById("retroSound").pause();
...
function showToast(message = "Conteúdo em breve!") {
